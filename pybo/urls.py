...
from .views import base_views, question_views, answer_views, comment_views, vote_views, apttrade_views
...
urlpatterns =[
    ...
    #아파트 실거래가 조회
    path('life/apttrade/', apttrade_views.apttrade, name="apttrade"),
]